  ...
  return (
    <div className="container mx-auto p-4 flex justify-center">
        <div className="max-w-sm rounded-lg overflow-hidden shadow-lg">
            ...
            <button onClick={() => setLiked((prevState) => !prevState)} className={`border-2 border-transparent px-2 -ml-2 mt-2 rounded-full transform transition duration-300 scale-110 hover:scale-125 ${ liked ? "fill-red-500" : "fill-gray-400"}`}>
